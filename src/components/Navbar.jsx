...
export default function Navbar() {
    ...
    return (
        <nav className={styles.nav}>
            <Helmet>
            <meta name="google-site-verification" content="reQeyS_IYC8aF7QgDwsR35wfPJuiz2nAetOufv3NT6s" />
                <meta charset="utf-8" />
                ...
                <meta property="og:image" content="/bpcoders-banner.jpg" />
                <meta property="twitter:image" content="/bpcoders-banner.jpg" />
                ...
                <meta name="twitter:creator" content="@B&amp;P Coders"/>
